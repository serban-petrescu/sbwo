...
public abstract class ReadEntityAction<T extends JournalizedBaseEntity, C extends JournalChannel>
		extends BaseBoAction<T, Integer, C> {

	protected ReadEntityAction(Class<T> entity, Class<C> channel) {
