...
public abstract class UpdateEntityAction<T extends JournalizedBaseEntity, C extends JournalChannel>
		extends BaseUserBoAction<T, C, Void> {

	protected UpdateEntityAction(Class<T> entity, Class<C> channel) {
