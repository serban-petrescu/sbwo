...
public class RestoreEntityAction<T extends JournalizedBaseEntity> extends BaseUserBoAction<T, Integer, Void> {

	public RestoreEntityAction(Class<T> entity, Class<?> channel) {
