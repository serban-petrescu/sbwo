...
public class DeleteEntityAction<T extends JournalizedBaseEntity> extends BaseUserBoAction<T, Integer, Void> {
	protected final long directDeleteInterval;

	public DeleteEntityAction(Class<T> entity, Class<?> channel) {
		this(entity, channel, -1);
	}

	public DeleteEntityAction(Class<T> entity, Class<?> channel, long directDeleteInterval) {
